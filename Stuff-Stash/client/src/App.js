...
function App() {
  ...
  return (
   //<Router>
    <div className="App">
      { (!isLoggedIn() && (pathname !== "/" && pathname !== "/reg" && pathname !== "/login")) ? 
        (checkRefresh(),pathname=window.location.pathname) : console.log("fuck you? no fuck me.")
    }
      <div className="content">
        <Navbar />
        <Switch>
          <Route path="/list" exact component={Helpme} />
          <Route path="/viewstockroomFrontend" exact component={viewstockroomFrontend} />
